<template>
  <div class="min-h-screen bg-gray-100">
    ...
    >
      ...
      <nav class="mt-8 flex-1">
        <div class="px-4 space-y-2">
          ...
          >
            <!-- Dashboard Icon -->
            <svg v-if="item.path === '/admin/dashboard'" class="mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <!-- Products Icon -->
            <svg v-else-if="item.path === '/admin/products'" class="mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
            </svg>
            <!-- Categories Icon -->
            <svg v-else-if="item.path === '/admin/categories'" class="mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
            </svg>
            <!-- Box Prices Icon -->
            <svg v-else-if="item.path === '/admin/box-prices'" class="mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
            </svg>
            <!-- Addresses Icon -->
            <svg v-else-if="item.path === '/admin/addresses'" class="mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <!-- Desktop sidebar -->
    <div class="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-50 lg:w-64 lg:bg-white lg:shadow-lg lg:flex lg:flex-col">
      <!-- Logo -->
        ...
        <div class="px-4 lg:px-6 py-4">
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2 lg:space-x-4">
              <span class="text-xs lg:text-sm text-gray-500 hidden sm:block">Bem-vindo, {{ adminInfo?.username }}</span>
              <NuxtLink
                to="/"
                target="_blank"
